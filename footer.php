	<footer>
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-xs-6 col-sm-3 col-sm3-offset-1">

					<a href="<?php echo get_site_url(); ?>/"><img src="/wp/wp-content/themes/oats/img/graphics/oats-logo-white.png" alt="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" class="img-responsive logo"></a>

					<p>168 7th Street, Suite 3A<br />
